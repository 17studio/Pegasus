...
typedef void (*ctp_md_user_login_rsp_cb)(CThostFtdcRspUserLoginField* user_login_field,
                                         CThostFtdcRspInfoField* info,
                                         int request_id,
                                         bool is_last);
typedef void (*ctp_md_user_logout_rsp_cb)(CThostFtdcUserLogoutField* user_logout_field,
                                          CThostFtdcRspInfoField* info,
                                          int request_id,
                                          bool is_last);
